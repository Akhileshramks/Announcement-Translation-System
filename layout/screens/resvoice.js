...
function updateVoice(voice) {
    // Update the voice setting globally or wherever it's stored
    config.voice = voice;
}
window.addEventListener('load', function () {
    // Function to speak text using the configured voice
